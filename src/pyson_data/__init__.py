    ...
    for item in open(filePath, "r").read().split("\n"):
        ...
        match data[1]:
            ...
            case _:
                ...
                raise Exception(
                    f"""Unknown data {data[1]} type found in {filePath} at call {data[0]}. Raw pyson data: {item}. Try checking if you have any external plugins that may be interfering with the pyson format. Or, if you entered the data manually, check if you made a typo. """)
